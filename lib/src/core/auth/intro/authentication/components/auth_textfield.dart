...
class AuthTextField extends StatefulWidget {
  ...
  const AuthTextField({
    ...
    this.focusIconColor = AppColors.colorWhite,
    this.cursorColor = AppColors.colorWhite,
    ...
    return Padding(
      ...
      child: Theme(
        data: Theme.of(context).copyWith(
          accentColor: widget.focusIconColor,
        ),
        child: TextFormField(
          obscureText: hiddenPassword == true ? true : false,
