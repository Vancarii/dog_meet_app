...
class MeetUpDetailsSheet extends StatefulWidget {
  @override
  _MeetUpDetailsSheetState createState() => _MeetUpDetailsSheetState();
}

class _MeetUpDetailsSheetState extends State<MeetUpDetailsSheet> {
