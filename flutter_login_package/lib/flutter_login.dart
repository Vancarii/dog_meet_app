...
class __HeaderState extends State<_Header> {
  ...
  Widget build(BuildContext context) {
    ...
    final logoHeight = min(
        (widget.height - MediaQuery.of(context).padding.top) - _titleHeight - gap, kMaxLogoHeight);
...
class _FlutterLoginState extends State<FlutterLogin> with TickerProviderStateMixin {
  ...
  ThemeData _mergeTheme({required ThemeData theme, required LoginTheme loginTheme}) {
    ...
    final isDefaultBlackText =
        theme.textTheme.headline3!.color == Typography.blackMountainView.headline3!.color;
    final titleStyle = theme.textTheme.headline3!
        .copyWith(
          color: loginTheme.accentColor ??
              (isDefaultBlackText ? Colors.white : theme.textTheme.headline3!.color),
          fontSize: loginTheme.beforeHeroFontSize,
          fontWeight: FontWeight.w300,
        )
        .merge(loginTheme.titleStyle);
    final textStyle =
        theme.textTheme.bodyText2!.copyWith(color: Colors.black54).merge(loginTheme.bodyStyle);
              ...
              child: Theme(
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    ...
                    Positioned.fill(
                        child: Align(alignment: Alignment.bottomCenter, child: footerWidget))
                  ],
                ),
              ),
            ),
